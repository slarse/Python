...
from ciphers import brute_force_caesar_cipher
...
def test_decryption_print(capsys, message, expected_output):
    """Test that the decryption prints expected output"""
    brute_force_caesar_cipher.decrypt(message)
