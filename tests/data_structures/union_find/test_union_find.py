...
class TestUnionFind():
    ...
    def test_init_with_invalid_size_1(self):
        with pytest.raises(ValueError):
            uf = UnionFind(0)
            
    def test_init_with_invalid_size_2(self):
        with pytest.raises(ValueError):
            uf = UnionFind(-5)
    ...
    def test_union_with_invalid_values_1(self):
        uf = UnionFind(10)
        with pytest.raises(ValueError):
            uf.union(-1, 1)
            
    def test_union_with_invalid_values_2(self):
        uf = UnionFind(10)
        with pytest.raises(ValueError):
            uf.union(11, 1)

    def test_same_set_with_valid_values_1(self):
        uf = UnionFind(10)
    ...
    def test_same_set_with_valid_values_2(self):
        uf = UnionFind(10)
        uf.union(1, 2)
    ...
    def test_same_set_with_invalid_values_1(self):
        uf = UnionFind(10)
        with pytest.raises(ValueError):
            uf.same_set(-1, 1)
            
    def test_same_set_with_invalid_values_2(self):
        uf = UnionFind(10)
        with pytest.raises(ValueError):
            uf.same_set(11, 0)
